...
House mansion = new House(140000.00, "Twenty-One Marudy Drive", 2400);
mansion.addRoom()
mansion.removeRoom()
mansion.paintHouse("blue")
mansion.paintHouse("yellow")
mansion.paintHouse("Red-Orange")
mansion.move("41 Mark Drive")
mansion.addBasement()
mansion.cost
mansion.removeBasement()
mansion.cost
mansion.removeBasement()
mansion.removeBasement()
mansion.removeBasement()
